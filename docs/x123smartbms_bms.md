...
| 18 | 2 | T-min | Minimum cell temperature, 1 °C/bit, offset `0x114` |
| 20 | 1 | T-min cell number | 1-based cell index |
| 21 | 2 | T-max | Maximum cell temperature, 1 °C/bit, offset `0x114` |
...
| 28 | 2 | cell temperature | Temperature of the cell from offset 24, offset `0x114` |
