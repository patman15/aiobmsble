...
@pytest.mark.parametrize("client", [MockDarenBleakClient, MockOversizedBleakClient])
async def test_device_info(
    ...
    if client == MockDarenBleakClient:
