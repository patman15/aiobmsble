...
def ref_value() -> dict[str, BMSSample]:
    ...
    return {
        "4S4Tv0.0": {
            ...
            "temp_values": [TS(23.2), TS(24.0), TS(22.6), TS(22.5)],
            "delta_voltage": 0.005,
            "chrg_mosfet": True,
            "dischrg_mosfet": True,
            "problem": False,
        ...
        "16S6Tv0.0": {
            ...
            "temp_values": [TS(v) for v in (17.9, 19.6, 17.9, 17.9, 17.9, 18.7)],
            "delta_voltage": 0.012,
            "runtime": 62589,
            "chrg_mosfet": True,
            "dischrg_mosfet": True,
        ...
        "16S6Tv0.4": {
            ...
            "temp_values": [TS(v) for v in (25.4, 25.1, 26.9, 25.9, 27.9, 27.2)],
            "voltage": 52.16,
            "current": -16.2,
            "cycle_charge": 64.5,
            "battery_level": 51,
